...
public class DataLayerImpl implements DataLayer {
  ...
  @Override public void loadSpiesFromLocal(Function<Spy, SpyDTO> translationBlock,
  ...
  @Override public void clearSpies(Action finished) throws Exception {
